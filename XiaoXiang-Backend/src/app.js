...
// product 模块路由（注意：使用不同的变量名避免冲突）
import productCategoryRoutes from './modules/product/routes/category.routes.js';
...
import productNotificationRoutes from './modules/product/routes/notification.routes.js';
import logRoutes from './modules/product/routes/log.routes.js';
...
// product 模块路由
console.log('[App] 📦 注册商品分类路由: /api/product/categories');
app.use('/api/product/categories', productCategoryRoutes);

console.log('[App] 📦 注册库存路由: /api/stock');
app.use('/api/stock', productRoutes);

console.log('[App] ♻️  注册回收路由: /api/recycle');
app.use('/api/recycle', recycleRoutes);

console.log('[App] 📊 注册报表路由: /api/report');
app.use('/api/report', reportRoutes);

console.log('[App] 🔔 注册产品通知路由: /api/product/notifications');
app.use('/api/product/notifications', productNotificationRoutes);

// 日志路由
console.log('[App] 📝 注册日志路由: /api/logs');
