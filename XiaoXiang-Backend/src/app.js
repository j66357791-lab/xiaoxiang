...
import statsRoutes from './modules/stats/stats.routes.js'; // 平台财务统计（保留原位置）
import { flipcardRoutes } from './modules/GameCenter/index.js';

// 🆕 从游戏中心统一引入游戏相关路由
import { 
  gameStatsRoutes,       // 游戏统计
  wheelGameRoutes,       // 转盘游戏
  mysteryShopRoutes,     // 神秘商店
  gamescaiquanRoutes,     // 猜拳游戏
  raceGameRoutes         // 👈 新增：龟兔赛跑
