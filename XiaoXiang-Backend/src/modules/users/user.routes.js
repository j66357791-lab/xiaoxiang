...
router.get('/my-team/search', authenticate, asyncHandler(UserController.searchTeamMembers));
router.get('/invite-task-info', authenticate, asyncHandler(UserController.getInviteTaskInfo));
...
// 获取好友奖励历史
router.get('/admin/team-members/:friendId/reward-history',
  authenticate,
  authorize('admin', 'superAdmin'),
  asyncHandler(UserController.getFriendRewardHistory)
);

// 撤回好友的所有奖励
router.delete('/admin/team-members/:friendId/rewards',
  authenticate,
  authorize('admin', 'superAdmin'),
  asyncHandler(UserController.revokeFriendRewards)
);

// 撤回指定订单的奖励
router.delete('/admin/orders/:orderId/reward',
  authenticate,
  authorize('admin', 'superAdmin'),
  asyncHandler(UserController.revokeOrderReward)
);
