...
export const TEAM_LEADER_RANKS = {
  ...
  6: { 
    ...
    yearlyBonusRate: 0,      // 私聊
  }
};

// 好友订单奖励配置
export const FRIEND_ORDER_REWARDS = {
  first: 18.88,   // 首单
  second: 8.88,   // 第二单
  third: 3.88,    // 第三单
...
export const NEWBIE_REWARDS = {
  ...
  payment: { name: '绑定收款方式奖励', amount: 5 },
  firstOrder: { name: '首单奖励', amount: 10 },
  secondOrder: { name: '第二单奖励', amount: 8 },
  subsequentOrder: { name: '后续订单奖励', amount: 3 },
  maxTotal: 100,
};
...
const UserSchema = new mongoose.Schema({
  ...
  frozenRewards: [{
    ...
    reason: { type: String, default: '好友未实名认证' },
...
UserSchema.statics.getTeamLeaderStats = async function(leaderId) {
  ...
  return {
    ...
    stats: {
      ...
      frozenEarnings: leader.frozenEarnings,
    },
    members: {
