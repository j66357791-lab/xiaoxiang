 ...
 * - user.service.profile.js - 个人资料修改（改名审核、头像）
 */
...
// 🆕 合并 Profile 模块（改名审核、头像修改）
Object.getOwnPropertyNames(UserServiceProfile).forEach(name => {
  if (typeof UserServiceProfile[name] === 'function') {
    UserServiceClass[name] = UserServiceProfile[name];
  }
});
