...
// 创建FAQ分类
router.post('/admin/faq/category', controller.createFAQCategory);

// 创建FAQ流程
router.post('/admin/faq/flow', controller.createFAQFlow);

// 使用FAQ流程回复
router.post('/admin/faq/use', controller.useFAQFlow);
